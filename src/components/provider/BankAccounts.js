            ...
            <ImageBackground source={require('../../../assets/images/bg.png')} style={{ width, height: 200, alignSelf: 'center', flexGrow: 1 }} resizeMode={'cover'}>
                ...
                <View animation="zoomInDown" easing="ease-out" delay={700} style={[styles.tripHeaderShadow, { backgroundColor: '#fff', }]}>
                    <View style={[styles.tripHeaderImage, styles.textCenter, { alignItems: 'center', justifyCenter: 'center' }]}>
                        ...
                        <Text style={[styles.textSize_16, styles.text_black, styles.textBold, styles.textCenter, styles.Width_90]}>{ i18n.t('amountPayed') } 100 ريال</Text>
                    </View>
                </View>
                ...
                <Content bounces={false} style={{ overflow: 'hidden', borderTopRightRadius: 50, marginTop: 40}}>
                    <View style={{ width: '100%', padding: 15, borderTopRightRadius: 50, backgroundColor: '#fff', minHeight: 110,paddingTop:85 }}>
                        ...
                        <ScrollView>
                            ...
                            <TouchableOpacity onPress={() => setActiveId(0)} style={[styles.Radius_7, styles.Width_100, styles.marginBottom_5]}>
                                <Card
                                    style={[styles.directionRow, styles.Radius_7, styles.bgFullWidth , activeId === 0 ? styles.borderBlue : null, {overflow: 'hidden'}]}>
                                    <View style={[styles.paddingHorizontal_10]}>
                                        <Image source={require('../../../assets/images/cib.png')}
                                    ...
                                    <View style={{flex: 1, marginLeft: 7, paddingRight: 7}}>
                                        <View style={[styles.directionRow, {flexWrap: 'wrap'}]}>
                                            ...
                                            <Text
                                                style={[styles.textRegular, styles.text_blue, styles.textSize_14, {marginLeft: 5}]}>cib</Text>
                                        </View>
                                        <View style={[styles.directionRow, {flexWrap: 'wrap'}]}>
                                            <Text
                                                style={[styles.textRegular, styles.text_black, styles.textSize_14]}>{i18n.t('accName')} :</Text>
                                            <Text
                                                style={[styles.textRegular, styles.text_blue, styles.textSize_14, {marginLeft: 5}]}>123456</Text>
                                        </View>
                                    </View>
                                </Card>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => setActiveId(1)} style={[styles.Radius_7, styles.Width_100, styles.marginBottom_5]}>
                                <Card
                                    style={[styles.directionRow, styles.Radius_7, styles.bgFullWidth , activeId === 1 ? styles.borderBlue : null, {overflow: 'hidden'}]}>
                                    <View style={[styles.paddingHorizontal_10]}>
                                        <Image source={require('../../../assets/images/cib.png')}
                                               style={[styles.icon100, styles.marginBottom_7]}
                                               resizeMode={'contain'}/>
                            ...
                            <TouchableOpacity onPress={() => setActiveId(2)} style={[styles.Radius_7, styles.Width_100, styles.marginBottom_5]}>
                                <Card
                                    style={[styles.directionRow, styles.Radius_7, styles.bgFullWidth , activeId === 2 ? styles.borderBlue : null, {overflow: 'hidden'}]}>
                                    <View style={[styles.paddingHorizontal_10]}>
                                        <Image source={require('../../../assets/images/cib.png')}
                                               style={[styles.icon100, styles.marginBottom_7]}
                                               resizeMode={'contain'}/>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('bankTransfer')} style={[styles.blueBtn , styles.Width_100 , styles.marginBottom_25 , styles.marginTop_40]}>
